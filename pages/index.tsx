...
const Home: NextPage = () => {
  return (
    <Layout title="home" hasTabBar>
      <div className="px-4 flex flex-col space-y-5 pb-10">
        {[
          ...
          >
            ...
            <div className="flex space-x-1.5 items-end justify-end">
              <div className="flex space-x-0.5 items-center text-sm">
                <svg
                  className="w-4 h-4"
                  fill="none"
                  stroke="currentColor"
        ...
        <Link href="/items/upload">
          <button
            className="fixed bottom-[120px] right-5 shadow-xl bg-orange-400 rounded-full p-4 text-white
